...
@section('page_title')
Añadir Sub Categoría - Tienda 
@endsection

@section('content')
    <!-- Basic Layout-->
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Página /</span> Añadir Sub Categoría</h4>
        <div class="col-xxl">
            <div class="card mb-4">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <h5 class="mb-0">Añadir nueva Sub Categoríaa </h5>
                ...
                <div class="card-body">
                    <form action="{{ route('storesubcategory') }}" method="POST">
                        ...
                        <div class="row justify-content-end">
                            <div class="col-sm-10">
                                <button type="submit" class="btn btn-primary">Añadir Sub Categoría</button>
                            </div>
                        </div>
                    </form>
                </div>
