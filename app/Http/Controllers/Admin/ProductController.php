...
class ProductController extends Controller
{
    ...
    public function StoreProduct(Request $request)
    {
        ...
        return redirect()->route('allproducts')->with('message', 'Producto Agregado Exitosamente!');
    }
    ...
    public function UpdateProductImg(Request $request)
    {
        ...
        return redirect()->route('allproducts')->with('message', 'Imagen Actualizada Correctamente!');
    }
